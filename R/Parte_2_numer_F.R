...
Df_smmart<-data[df$failure=='1',]
Df_smmart$failure=NULL
Df_smmart$vida_util_restante_int=NULL
Df_smmart$vida_util_restante=NULL
Df_smmart$vida_util=NULL
Df_smmart$vida_util_days=NULL
Df_smmart$end_date=NULL
Df_smmart$date=NULL
#Df_smmart$serial_number=NULL


disc=Df_smmart$serial_number
